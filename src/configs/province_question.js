const province_question = {
    subtitle: 'Bước 5/5',
    title: 'Tỉnh/Thành phố đang cư trú của bạn',
    button: 'Hoàn tất',
    options: [
        ...
        { label: "Hải Dương", value: "Hải Duơng" },
    ...
    not_select_msg: "Bạn chưa chọn Tỉnh/Thành phố",
    invalid_msg: "Vui lòng nhập đúng tỉnh thành",
    not_found_content: "Không tìm thấy"
}
export default province_question;
